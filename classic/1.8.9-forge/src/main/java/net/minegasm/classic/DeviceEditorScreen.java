...
/**
 * 1.8.9 mirror of the modern {@code MinegasmDeviceEditorScreen}: per-device enable/intensity cap/
 ...
 * are flushed rather than callback-driven, and the 1.8.9 {@code fontRendererObj}/{@code buttonList}
 * API notes.
 */
