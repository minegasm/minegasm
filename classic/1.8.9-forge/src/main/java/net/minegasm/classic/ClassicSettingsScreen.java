...
/**
 * The gameplay/connection settings sub-screen for Minecraft 1.8.9, reached from the dashboard's Settings
 ...
 *
 * <p>Sibling of the 1.12.2 and 1.7.10 settings screens. On 1.8.9 the font accessor is
 * {@code fontRendererObj} and buttons are added straight to {@code buttonList}.
 */
