...
/**
 * 1.7.10 mirror of the modern {@code MinegasmCustomizationScreen}: per-event enable/multiplier,
 ...
 *
 * <p>Sibling of the 1.8.9 and 1.12.2 customization screens. On 1.7.10 the font accessor is
 * {@code fontRendererObj}, widgets are added straight to {@code buttonList} (no {@code addButton}),
 * {@code GuiScreen} callbacks do not throw {@code IOException}, and the slider is {@code cpw.mods.fml}'s.
 *
