...
/** Editor for one bridge endpoint on 1.7.10, matching the 1.16.5 and modern editors (ADR-018). */
public final class ClassicBridgeEditScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        nameField = new GuiTextField(fontRendererObj, x, 52, w, 18);
        nameField.setMaxStringLength(48);
        nameField.setText(existing ? bridges.get(index).name() : "bridge-" + (bridges.size() + 1));

        urlField = new GuiTextField(fontRendererObj, x, 84, w, 18);
