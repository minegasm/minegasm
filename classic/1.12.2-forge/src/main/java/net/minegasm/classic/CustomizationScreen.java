...
/**
 * 1.12.2 mirror of the modern {@code MinegasmCustomizationScreen}: per-event enable/multiplier,
...
public final class CustomizationScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(fontRenderer, "Minegasm Customization", width / 2, 16, 0xFFFFFF);
