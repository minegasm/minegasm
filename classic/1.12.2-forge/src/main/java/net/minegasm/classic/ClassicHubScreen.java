...
/**
 * The Minegasm entry screen for 1.12.2: a hub where every integration is a peer (ADR-018). Buttplug and
...
public final class ClassicHubScreen extends GuiScreen {
    ...
    public void updateScreen() {
        // Rebuild when a bridge link changes or the safety state changes, so the labels never go stale.
