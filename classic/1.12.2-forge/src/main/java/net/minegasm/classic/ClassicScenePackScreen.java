...
/**
 * Scene-pack picker for 1.12.2, reached from the dashboard and from the settings recipe row. Lists the
...
public final class ClassicScenePackScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(fontRenderer, "Minegasm Scene Packs", width / 2, 20, 0xFFFFFF);
        drawCenteredString(fontRenderer, client.scenePackCount()
