...
final class B4jDeviceMapper {
    ...
    private static HapticFeature mapFeature(ButtplugClientDeviceFeature feature) {
        ...
        Map<ButtplugOutput, ?> advertised = feature.getOutput();
        if (advertised != null) {
        ...
        Map<InputKind, InputCapability> inputs = java.util.Collections.emptyMap(); // battery/RSSI unused for output in the MVP
