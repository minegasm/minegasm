 ...
 *
 * <p>Compiled by the Gradle+NeoForge toolchain only; validate event/screen APIs against the pinned
 * 26.x build (see {@code package-info}).
 */
    ...
    private void showToast(Minecraft mc, String key, String detailKey) {
        ...
        if (mc != null && mc.gui != null) {
            ...
            SystemToast.addOrUpdate(mc.gui.toastManager(), PANIC_TOAST,
                    ...
                    detailKey == null ? net.minecraft.network.chat.Component.empty()
                            : net.minecraft.network.chat.Component.translatable(detailKey));
            //?} else {
