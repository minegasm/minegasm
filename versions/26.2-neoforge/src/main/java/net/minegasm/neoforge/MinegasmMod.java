 ...
 *
 * <p>Lives under {@code versions/26.2-neoforge/src}, not the shared root {@code src}: NeoForge is now
 ...
 * these imports (ADR-011, ADR-012). The 26.1.2 variant has its own copy
 * ({@code versions/26.1.2-neoforge/src/.../MinegasmMod.java}) using that line's pre-26.2 toast API
